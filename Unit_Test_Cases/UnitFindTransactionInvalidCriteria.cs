...
{
    public class UnitFindTransactionInvalidCriteria : LoginPageTest
    {
        ...
        public async Task FindTransactions_Should_ShowError_WhenCriteriaAreInvalid()
        {
            ...
            string invalidAccountNumber = "138997";

            await _page.GotoAsync(testUrl);
            await _page.FillAsync("input[name='accountId']", invalidAccountNumber);
            await _page.ClickAsync("input[value='Find Transactions']");

...
{
    public class UnitValidAccountSufficientFund : LoginPageTest
    {
        ...
        //    await openNewAccount.OpenNewAccountAsync("SAVINGS", "137887", "$100.00");
        //    await openNewAccount.OpenNewAccountAsync("CHECKING", "137887", "$100.00");

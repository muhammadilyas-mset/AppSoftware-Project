...
namespace Register_Existing

{
    public class Register_Existing_Email
    {
        private IPage _page;
        ...
        public Register_Existing_Email(IPage page)
        {
            _page = page;
        ...
        public async Task RegisterUpMethod(
            string username,
            string SSN,
            string password,
            string FirstName,
    ...
    public async Task ValidateUnSuccessfullLogin()
        {
            Assert.That(await _page.InnerTextAsync("body > section:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > form:nth-child(2) > p:nth-child(5)"), Is.EqualTo("This username already exists.\r\n!"));
        }
    }
}
